...
-- Dumping data for table article.articles: ~8 rows (approximately)
...
INSERT INTO `articles` (`id`, `title`, `content`) VALUES
	...
	(16, 'Fintech startup MC Payment to acquire iFashion Group, proceed with reverse takeover plans', 'According to documents filed with the Singapore Exchange, MC Payment will acquire iFashion in full for up to US$18.7 million. The lifestyle platform itself has adopted a model of growth via acquisitions, snapping up fashion and ecommerce labels in Southeast Asia including Dressabelle, Megafash, and Nose.');
...
-- Dumping data for table article.comments: ~2 rows (approximately)
